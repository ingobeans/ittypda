...
the command you need to run is `easyeda2kicad --full --lcsc_id C318884 C191023 C22435642`

which will download footprints/symbols/3d models for the switches, diodes, and the 14P FPC connector
