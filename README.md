...
the command you need to run is `easyeda2kicad --full --lcsc_id C318884 C191023 C22435642 C13738 C81080 C49023767 C19273152`

which will download footprints/symbols/3d models for the switches, diodes, the 14P FPC connector, the crystal, etc.
